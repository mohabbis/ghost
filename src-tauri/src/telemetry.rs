...
impl TelemetryManager {
    ...
    pub fn track_event(&self, event_type: impl Into<String>, properties: std::collections::HashMap<String, serde_json::Value>) {
        if !self.is_enabled() {
            return;
        }
    ...
    pub fn track_workflow_recorded(&self, event_count: usize, duration_secs: u64) {
        ...
        props.insert("duration_secs".to_string(), serde_json::json!(duration_secs));
    ...
    pub fn track_feature_used(&self, feature: impl Into<String>) {
        ...
        let mut props = std::collections::HashMap::new();
        props.insert("feature".to_string(), serde_json::json!(feature_name.clone()));
    ...
    pub fn track_error(&self, error_type: impl Into<String>, error_code: impl Into<String>) {
        ...
        let mut props = std::collections::HashMap::new();
        props.insert("error_type".to_string(), serde_json::json!(error_type_str.clone()));
        props.insert("error_code".to_string(), serde_json::json!(error_code.into()));
